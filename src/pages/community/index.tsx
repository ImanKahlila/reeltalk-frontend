...
const DUMMY_POP_COM = [
    ...
    },
    {
        ...
        members: 300,
        description:
            'Potterhead is a community for fans of Harry Potter film series. ',
    },
];
            ...
            <div className='mx-auto max-w-[352px] md:m-0'>
                ...
                <div className='mt-4 rounded-lg bg-first-surface px-5 py-6'>
                    <p className='text-high-emphasis'>
                        Welcome to our community of TV and movie fanatics! This
                        is a space for people who love discussing and dissecting
                        all things television and film to connect over their
                        shared passion. Join in on the latest conversations
                        about popular shows, cult classics, box office hits, and
    ...
    return (
        <div className='flex h-fit gap-8 bg-first-surface p-2'>
            ...
            <div className='w-full'>
                <h2 className='font-medium tracking-[0.24px] text-high-emphasis'>
                    {title}
                </h2>
                ...
                <div className='mt-4 flex flex-col gap-2 rounded-lg bg-second-surface p-2 text-high-emphasis'>
                    <div className='flex gap-4'>
                        ...
                        <div>
                            <h3 className='text-high-emphasis'>
                                Jennifer L.{' '}
                                <span className='pl-2 text-sm text-medium-emphasis'>
                                    2h ago
                                </span>
                            </h3>
                            <p>
                                In your opinion, what are the top 5 scenes of
                                Frozen?
                            </p>
                        </div>
                    </div>
                    <div className='flex gap-[10px] text-xs tracking-[0.24px] text-medium-emphasis'>
                        ...
                        <div className='flex items-center gap-[5px]'>
                            <MessageBubbleIcon className='inline-block' />{' '}
