    ...
    return (
        <section className='mx-auto max-w-2xl px-4 py-12'>
            ...
            <div className='mt-5 flex h-fit w-full flex-col gap-6 rounded-lg bg-first-surface px-4 py-6 text-sm tracking-[0.07px] text-high-emphasis md:mt-10'>
                ...
                <p>
                    Reel Talk Llc. and its affiliates (“Reel Talk,” “we,” “our,”
                    and/or “us”) value the privacy of individuals who use our
                    application, websites, and related services (collectively,
                    our “Services”). This privacy policy (the “Privacy Policy”)
                    explains how we collect, use, and share information from
                    users who use our Services (collectively, “Users” or “you”).
                    By using our Services, you agree to the collection, use,
                    disclosure, and procedures this Privacy Policy describes.
                    Beyond the Privacy Policy, your use of our Services is also
                ...
                <div>
                    ...
                    We may collect a variety of information from or about you or
                    your devices from various sources, as described below.
                </div>
                ...
                <div>
                    ...
                    <div className='mt-2'>
                        ...
                        When you sign up for an account, or sign up for
                        notifications or updates, we may collect your name,
                        email address, and phone number. If you sign up using a
                        LinkedIn or Facebook account, we will also receive
                        information from that service such as your name, email,
                        and workplace.{' '}
                    </div>
                    <div className='mt-6'>
                        <div className={subheading}>Location Information.</div>{' '}
                        When you use our Services, we receive your precise
                        location information. We use your location information
                        to provide personalized job opportunities. We also infer
                    ...
                    <p className='mt-6'>
                        ...
                        Users may provide information about themselves in
                        connection with relationship and connection
                    ...
                    <p className='mt-6'>
                        ...
                        customer support team or request to receive updates
                        about our product launches, we may receive your name,
                ...
                <div>
                    ...
                    <p className='mt-2'>
                        ...
                        browser type, operating system version, phone carrier
                    ...
                    <p className='mt-6'>
                        ...
                        about your interactions with our Services, like the
                    ...
                    <p className='mt-6'>
                        ...
                        cookies, pixel tags, or similar technologies. Our third
                        party partners, such as analytics and advertising
                        partners, may use these technologies to collect
                        information about your online activities over time and
                        across different services. Cookies are small text files
                        containing a string of alphanumeric characters. We may
                        use both session cookies and persistent cookies. A
                        session cookie disappears after you close your browser.
                ...
                <div>
                    ...
                    <ul className='mt-2 flex list-disc flex-col gap-1 pl-4'>
                        ...
                        <li>
                            To personalize your experience on our Services such
                            as by providing tailored content and
                            recommendations;
                        </li>
                        <li>
                        ...
                        <li>
                            To communicate with you, provide you with updates
                            and other information relating to our Services,
                            provide information that you request, respond to
                            comments and questions, and otherwise provide
                            customer support;
                        </li>
                        <li>
                            For marketing and advertising purposes, including
                            serving personalized advertisements, and developing
                            and providing promotional and advertising materials
                            that may be relevant, valuable or otherwise of
                            interest to you;
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            Terms of Service or other legal rights, or as may be
                ...
                <div>
                    ...
                    <div>
                        ...
                        <p className='mt-6'>
                            ...
                            yourself. In addition to the content you post, your
                            username, profile picture, and public profile
                            content will also be accessible to other Users on
                            the Service. We are not responsible for the other
                        ...
                        <p className='mt-6'>
                            ...
                            to collect and process certain analytics data. These
                            services may also collect information about your use
                            of other websites, apps, and online resources. You
                        ...
                        <p className='mt-6'>
                            ...
                            We work with third party advertising partners to
                            show you ads that we think may interest you. Some of
                            our advertising partners are members of the Network
                            ...
                            ads from member companies. You can access any
                            settings offered by your mobile operating system to
                            limit ad tracking, or you can install the AppChoices
                            mobile app to learn more about how you may opt out
                            of personalized ads in mobile apps. You may also opt
                            out of seeing personalized ads on our Services by
                        ...
                        <p className='mt-6'>
                            ...
                            appropriate to: (a) comply with law enforcement
                            requests and legal process, such as a court order or
                            subpoena; (b) respond to your requests; or (c)
                        ...
                        <p className='mt-6'>
                            ...
                            We may transfer your information to service
                            providers, advisors, potential transactional
                            partners, or other third parties in connection with
                            the consideration, negotiation, or completion of a
                            corporate transaction in which we are acquired by or
                            merged with another company or we sell, liquidate,
                            or transfer all or a portion of our assets. The use
                            of your information following any of these events
                ...
                <div>
                    ...
                    <div>
                        <p className='mt-2'>
                            ...
                            We provide you with settings to allow you to set
                            your sharing preferences for content you post to the
                        ...
                        <p className='mt-6'>
                            ...
                            You can unsubscribe from our promotional emails via
                        ...
                        <p className='mt-6'>
                            ...
                            You can prevent your device from sharing precise
                            location information at any time through your
                ...
                <div>
                    ...
                    <div>
                        <p className='mt-2'>
                            We make reasonable efforts to protect your
                            information by using physical and electronic
                            safeguards designed to improve the security of the
                            information we maintain. However, as our Services
                            are hosted electronically, we can make no guarantees
                ...
                <div>
                    ...
                    <div>
                        <p className='mt-2'>
                            ...
                            personal information from children under 13 years of
                            age, and no part of our Services are directed to
                            ...
                            <Link
                                className='text-primary'
                                href={'mailto:reelworldapp@gmail.com'}
                            >
                ...
                <div>
                    ...
                    <div>
                        <p className='mt-2'>
                            ...
                            European Union or other regions of the world with
                            laws governing data collection and use that may
                            differ from U.S. law, then please note that you are
                            transferring your personal information outside of
                            those regions to the United States for storage and
                            processing. Also, we may transfer your data from the
                            U.S. to other countries or regions in connection
                            with storage and processing of data, fulfilling your
                            requests, and operating the Services. By providing
                            any information, including personal information, on
                            or to the Services, you consent to such transfer,
                ...
                <div>
                    ...
                    <div>
                        <p className='mt-2'>
                            You can update your account and profile information
                            or close your account through settings within the
                            Services. If you have questions about your privacy
                            on the Services or this privacy policy, please
                            contact us at{' '}
                            <Link
                                className='text-primary'
                                href={'mailto:reelworldapp@gmail.com'}
                ...
                <div>
                    ...
                    <div>
                        <p className='mt-2'>
                            ...
                            the Services, we will notify you through the
                ...
                <div>
                    ...
                    <div>
                        <p className='mt-2'>
                            ...
                            or write to us at 6548 Bradley Place, Los Angeles,
                            CA 90056.
                        </p>
                    </div>
                </div>
